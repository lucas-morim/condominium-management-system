...
Public Class CrpEncomendas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HelvetiaSoftware.CrpEncomendas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpEncomendas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpEncomendas = New CrpEncomendas()
        rpt.Site = Me.Site
        Return rpt
    End Function
