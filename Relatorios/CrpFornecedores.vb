...
Public Class CrpFornecedores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HelvetiaSoftware.CrpFornecedores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpFornecedores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpFornecedores = New CrpFornecedores()
        rpt.Site = Me.Site
        Return rpt
    End Function
