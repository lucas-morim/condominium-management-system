...
Public Class CrpGraficoReservas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HelvetiaSoftware.CrpGraficoReservas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpGraficoReservas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpGraficoReservas = New CrpGraficoReservas()
        rpt.Site = Me.Site
        Return rpt
    End Function
