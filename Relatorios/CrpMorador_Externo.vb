...
Public Class CrpMorador_Externo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HelvetiaSoftware.CrpMorador_Externo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpMorador_Externo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpMorador_Externo = New CrpMorador_Externo()
        rpt.Site = Me.Site
        Return rpt
    End Function
