...
Public Class CrpMoradores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HelvetiaSoftware.CrpMoradores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpMoradores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpMoradores = New CrpMoradores()
        rpt.Site = Me.Site
        Return rpt
    End Function
