...
Public Class CrpMultasUnicas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HelvetiaSoftware.CrpMultasUnicas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpMultasUnicas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpMultasUnicas = New CrpMultasUnicas()
        rpt.Site = Me.Site
        Return rpt
    End Function
